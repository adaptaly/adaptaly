...
export default function ExamplePreview() {
  return (
    <div className="up-card up-block" aria-labelledby="example-preview">
      <h3 id="example-preview" className="up-block-title">What you will get</h3>
      <div className="up-preview">
        <div className="up-preview-card">
          <p className="up-mini-title">Summary preview</p>
          <div className="up-skeleton up-summary-line" style={{ width: "92%" }} />
          <div className="up-skeleton up-summary-line" style={{ width: "86%" }} />
          <div className="up-skeleton up-summary-line" style={{ width: "70%" }} />
        </div>
