...
/**
 * Adaptaly — Signup choice screen
 * Icons sit directly beside labels with an 10–12px gap.
 * Accessible focus states, loading, and reduced-motion are included.
 */
